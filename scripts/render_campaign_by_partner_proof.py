...
def mock_rows() -> list[ReportRow]:
    return [
        ...
        ReportRow("Briarwood Partners", "Contacted", "June 3, 2026", Decimal("1000"), None, None),
        ReportRow("Caldwell Group", "Pledged", "June 6, 2026", Decimal("2500"), Decimal("1000"), None),
        ReportRow("Dunhill Associates", "Gift Received", "June 8, 2026", Decimal("5000"), Decimal("5000"), Decimal("5000")),
        ReportRow("Elm Street Collective", "Declined", "June 10, 2026", Decimal("750"), None, None),
        ...
        ReportRow("Harbor Point Associates", "Pledged", "June 12, 2026", Decimal("3000"), Decimal("1500"), Decimal("500")),
        ReportRow("Ivy Ridge Company", "Gift Received", "June 14, 2026", Decimal("1000"), Decimal("1000"), Decimal("1000")),
        ReportRow("Juniper Lane Partners", "Contacted", "June 15, 2026", Decimal("7500"), None, None),
        ReportRow("Keystone Circle", "Declined", "June 15, 2026", Decimal("500"), None, None),
        ReportRow("Larkspur Holdings", "Pledged", None, Decimal("2500"), Decimal("2500"), None),
        ReportRow("Monument Square Group", "Gift Received", "June 17, 2026", Decimal("10000"), Decimal("10000"), Decimal("10000")),
        ReportRow("Northgate Partners", "Not Contacted", None, Decimal("1250"), None, None),
        ReportRow("Oak Hill Collaborative", "Contacted", "June 19, 2026", Decimal("5000"), None, None),
        ReportRow("Pinecrest Alliance", "Pledged", "June 20, 2026", Decimal("3500"), Decimal("2000"), None),
        ReportRow("Quarry Run Group", "Gift Received", "June 22, 2026", Decimal("800"), Decimal("800"), Decimal("800")),
        ReportRow("Riverside Circle", "Declined", None, Decimal("600"), None, None),
        ReportRow("St. Bridget Wellness & Rehabilitation Center", "Pledged", "June 24, 2026", Decimal("10000"), Decimal("7500"), Decimal("2500")),
        ReportRow("The Very Long Name Foundation for Community Partnerships and Scholarship Support", "Contacted", "June 25, 2026", Decimal("10000"), None, None),
    ]
